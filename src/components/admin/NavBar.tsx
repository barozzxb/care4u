                ...
                {email ? (
                    <>
                        <button
                            ...
                            type="button"
                        >
                            <Image src={`${IMG_HOST}${userDetail?.avatar}`} alt="avatar" width={50} height={50} className=" rounded-full"/>
                        ...
                        {dropdownOpen && (
                            ...
                            >
                                ...
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDividerButton">
                                    ...
                                    <li>
                                        <a href="/admin/info" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Thông tin</a>
                                    </li>
                                </ul>
                                <div className="py-2">
