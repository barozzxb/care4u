    ...
    <div className="h-full p-0 bg-gradient-to-b from-blue-50 via-white to-amber-50 border-r border-gray-200 shadow-2xl flex flex-col items-center">
      <nav className="w-full flex-1">
        <ul className="space-y-2 px-4">
          <li>
            <Link href="/admin/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-lg text-blue-700 font-semibold bg-blue-100 hover:bg-blue-200 transition-all shadow group">
          ...
          <li>
            <Link href="/admin/departments" className="flex items-center gap-3 px-4 py-3 rounded-lg text-pink-700 font-semibold bg-pink-100 hover:bg-pink-200 transition-all shadow group">
      ...
      <div className="w-full px-4 py-6 mt-auto">
        <Link href="/logout" className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-amber-400 text-white font-bold shadow-lg hover:scale-105 transition-all">
