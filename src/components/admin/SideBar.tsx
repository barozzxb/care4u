    ...
    <div className="h-full p-0 bg-gradient-to-b from-blue-50 via-white to-amber-50 border-r border-gray-200 shadow-2xl flex flex-col items-center">
      <nav className="w-full flex-1">
        <ul className="space-y-2 px-4">
          <li>
            <Link href="/admin" className="flex items-center gap-3 px-4 py-3 rounded-lg text-blue-700 font-semibold bg-blue-100 hover:bg-blue-200 transition-all shadow group">
          ...
          <li>
            <Link href="/admin/accounts" className="flex items-center gap-3 px-4 py-3 rounded-lg text-amber-700 font-semibold bg-amber-100 hover:bg-amber-200 transition-all shadow group">
