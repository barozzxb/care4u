  ...
  return (
    <div className="h-full p-0 bg-gradient-to-b from-blue-50 via-white to-amber-50 border-r border-gray-200 shadow-2xl flex flex-col items-center">
      <div className="flex flex-col items-center py-8 w-full bg-gradient-to-r from-blue-200 to-amber-100 rounded-b-3xl shadow-lg mb-6">
        ...
        <span className="text-xl font-extrabold text-blue-950 tracking-wide drop-shadow">User's Name</span>
        <span className="text-xl text-blue-950 tracking-wide drop-shadow">Age: 30</span>
      </div>
      <nav className="w-full flex-1">
        <ul className="space-y-2 px-4">
          <li>
            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-blue-700 font-semibold bg-blue-100 hover:bg-blue-200 transition-all shadow group">
          ...
          <li>
            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-pink-700 font-semibold bg-pink-100 hover:bg-pink-200 transition-all shadow group">
          ...
          <li>
            <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-amber-700 font-semibold bg-amber-100 hover:bg-amber-200 transition-all shadow group">
